...
export function Icon({ name, className = 'h-5 w-5' }: { name: string; className?: string }) {
  const paths: Record<string, ReactNode> = {
    ...
    syringe: (
      <>
        <path d="M18 2l4 4" />
        <path d="M17 7l-2.5-2.5L4 15v5h5L19.5 9.5" />
        <path d="M9 11l2 2" />
        <path d="M12 8l2 2" />
      </>
    ),
    flask: (
      <>
        <path d="M9 3h6" />
        <path d="M10 3v5L4.6 18a2 2 0 0 0 1.8 3h11.2a2 2 0 0 0 1.8-3L14 8V3" />
        <path d="M7.5 14h9" />
      </>
    ),
    tooth: (
      <>
        <path d="M7.6 3.3c-2.6.4-3.9 2.7-3.5 5.3.3 2 1.1 3 1.3 5.2.2 2.2.5 6.2 2.3 6.2 1.9 0 1.5-4.5 3.4-4.5.4 0 .8 0 1.8 0 1.9 0 1.5 4.5 3.4 4.5 1.8 0 2.1-4 2.3-6.2.2-2.2 1-3.2 1.3-5.2.4-2.6-.9-4.9-3.5-5.3-1.9-.3-3 .7-4.4.7s-2.5-1-4.4-.7z" />
      </>
    ),
    eye: (
      <>
    ...
    scissors: (
      <>
        ...
        <path d="M8.2 7.6L20 19" />
        <path d="M8.2 16.4L20 5" />
      </>
    ),
