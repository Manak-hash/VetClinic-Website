...
const en: Messages = {
  ...
  home: {
    ...
    reviews: {
      ...
      rating: '4.3',
      items: [
        { author: 'Asmaa B.', stars: 5, when: 'a year ago', text: 'The best veterinarian I have ever seen, very competent, he did exceptional work and saved my cat who was going to die. A thousand thanks to Dr Bassir, who is the best, really HIGHLY RECOMMENDED.' },
        { author: 'Kenza B.', stars: 5, when: 'a year ago', text: 'A very committed and kind doctor who met us in the middle of the night and saved our dog’s life. The staff are also very kind and affectionate with the animals. Highly recommended!' },
        { author: 'Mia M.', stars: 5, when: '6 months ago', text: 'I have been bringing my dog (a malinois) for over 3 years and I am very satisfied. The doctor is very kind, attentive, helpful, and the prices are reasonable. Thank you so much for the quality of your work.' },
        { author: 'Rita I.', stars: 5, when: '2 years ago', text: 'This has been my veterinary clinic for almost 9 years, and I am very, very happy with them for my babies. Impeccable, with so much humanity. The staff are wonderfully caring too.' },
        { author: 'Amal H.', stars: 4, when: '2 years ago', text: 'I have been seeing Dr Bassir, my cats’ veterinarian, for more than 15 years, and I am very satisfied with his services. His expertise and skill with animals, especially cats, are remarkable!' },
        { author: 'Fatim-Zohra A.', stars: 5, when: '2 years ago', text: 'A top clinic, very clean at any hour. Quality care and surgery. A veterinarian who listens to owners and their animals. A very competent, very kind, friendly team, always smiling.' },
      ],
    },
  ...
  services: {
    ...
    xrayLegAlt: 'X-ray of a limb — imaging exam performed at the clinic',
    xrayOtherAlt: 'Veterinary X-ray — read on site by Dr Bassir',
